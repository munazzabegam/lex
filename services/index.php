<?php
// Remove path configuration include
    ...
    <section class="services-overview py-5">
        <div class="container">
            ...
            <div class="row g-4" id="servicesGrid">
                ...
                $services = [
                    [
                        'img' => $asset_path . 'assets/images/card_images/civil_law_card.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                        'title' => 'Civil Law',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/criminal_law_card.jpeg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                        'title' => 'Criminal Law',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/family-law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                        'title' => 'Family Law',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/Administrative-Law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/soundblock-Wood-scales-books-stack-background-leather.webp',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/real_estate_law.jpeg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/constitutional_law.jpeg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/tax_law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                        'title' => 'Tax Law',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/environmental_law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/Intellectual-property.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/cyber_law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/consumer_law.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/Blog photos_human rights lawyers.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/Finance_law.webp',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/ADR.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
                    ...
                    [
                        'img' => $asset_path . 'assets/images/card_images/international-law-.jpg',
                        'svg' => $asset_path . 'assets/images/icons/gavel.svg',
    ...
    <section class="why-choose-us py-5 position-relative" style="background: url('../assets/images/image2.jpg') center center/cover no-repeat;height: 80vh;">
        ...
        <div class="container position-relative" style="z-index:2;">
            ...
            <div class="row g-4">
                ...
                $features = [
                    [
                        'svg' => $asset_path . 'assets/images/icons/team.svg',
                        'title' => 'Expert Team',
                        'description' => 'Highly qualified and experienced legal professionals.'
                    ],
                    [
                        'svg' => $asset_path . 'assets/images/icons/support.svg',
                        'title' => '24/7 Support',
                        'description' => 'Round-the-clock assistance for urgent legal matters.'
                    ],
                    [
                        'svg' => $asset_path . 'assets/images/icons/focus.svg',
                        'title' => 'Client Focus',
