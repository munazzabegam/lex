...
<nav class="navbar navbar-expand-lg fixed-top navbar-blur">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="<?php echo $asset_path; ?>index.php">
            <img src="<?php echo $asset_path; ?>assets/images/logo.png" alt="Lex Juris Logo" style="height:50px;width:auto;margin-right:10px;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_full_path === '/index.php') ? 'active' : ''; ?>" href="<?php echo $asset_path; ?>index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($current_full_path, '/about/') !== false ? 'active' : ''; ?>" href="<?php echo $asset_path; ?>about/">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($current_full_path, '/services/') !== false ? 'active' : ''; ?>" href="<?php echo $asset_path; ?>services/">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo strpos($current_full_path, '/teams/') !== false ? 'active' : ''; ?>" href="<?php echo $asset_path; ?>teams/">Teams</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-12 text-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="<?php echo $asset_path; ?>index.php" class="text-white">Home</a></li>
